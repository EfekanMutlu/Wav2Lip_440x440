    ...
    def __getitem__(self, idx):
        while 1:
            ...
            try:
              ...
              print("wav path hatası, path:",wavpath)
              if isinstance(e, FileNotFoundError):
                print("Durum 1: Dosya bulunamadı")
                print("Exception:", e)
                print("Debug:", f"Tried to access {wavpath}")
              elif isinstance(e, PermissionError):
                print("Durum 2: İzin Problemleri")
                print("Exception:", e)
                print("Debug:", f"Tried to access {wavpath} with insufficient permissions")

              elif isinstance(e, ValueError) or isinstance(e, RuntimeError):
                print("Durum 3: Ses Dosyası Format Problemleri")
                print("Exception:", e)
                print("Debug:", f"Tried to load invalid audio file {wavpath}")

              elif isinstance(e, ValueError):
                print("Durum 4: Örnek Hız Uyuşmazlığı")
                print("Exception:", e)
                print("Debug:", f"Tried to load audio file {wavpath} with unmatched sample rate {hparams.sample_rate}")

              else:
                print("Durum 5: Diğer Exceptionlar")
                print("Exception:", e)
                print("Debug:", f"Unexpected error occurred while processing {wavpath}")
              continue
