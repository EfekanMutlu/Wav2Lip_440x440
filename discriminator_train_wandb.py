...
def train(device, model, train_data_loader, test_data_loader, optimizer,
    ...
    while global_epoch < nepochs:
        ...
        for step, (x, mel, y) in prog_bar:
            ...
            wandb.log({'train_loss': running_loss / (step + 1), 'global_step': global_step, 'epoch': global_epoch})

            if global_step == 1 or global_step % checkpoint_interval == 0:
                save_checkpoint(
                    model, optimizer, global_step, checkpoint_dir, global_epoch)
                wandb.save(f'{checkpoint_dir}/checkpoint_step_{global_step}.pth')
...
def eval_model(test_data_loader, global_step, device, model, checkpoint_dir):
    ...
    while 1:
        ...
        wandb.log({'eval_loss': averaged_loss, 'global_step': global_step})
